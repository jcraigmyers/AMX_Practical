...
(*********************************************************************)
MODULE_NAME = 'Epson_PowerLite905SourceSelectComponent' (dev vdvDev[], dev dvTP, INTEGER nDevice, INTEGER nPages[])
(***********************************************************)
(* System Type : NetLinx                                   *)
...
{
    SEND_COMMAND vdvDev[1], '?INPUTPROPERTIES'
    SEND_COMMAND vdvDev[1], '?INPUTSELECT'
